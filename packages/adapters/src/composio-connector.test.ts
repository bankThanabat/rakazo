...
describe("composio tool mapping", () => {
  ...
  it("only fetches live Composio slugs when a Deskazo row is still pending or errored", () => {
  ...
  it("plans DB sync when Composio is connected but Deskazo is still pending", () => {
    expect(
      planLiveConnectionSync(
        [
