export const SITE_NAME = "Deskazo";
export const SITE_URL = "https://rakazo.com";
export const SITE_DESCRIPTION =
  "Deskazo is an open source Grok Bot alternative for persistent AI teammates that do real work. Your keys, your model, your machine.";
