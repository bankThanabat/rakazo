...
For customer-facing conversations, configure **Integrations → Channels**. See [Customer messaging](self-host/customer-channels.md) for webhook setup, supported adapters, staff takeover and verification.
