export const ZH_MESSAGES: Record<string, string> = {
  "Delivery unconfirmed": "送达状态未确认",
  "Review memory change": "审核记忆更改",
  "Review skill change": "审核技能更改",
  ...
  "Could not confirm the change. Retry or reload history.":
    "无法确认更改。请重试或重新加载历史记录。",
  "Restore memory": "恢复记忆",
  "Restore this fact": "恢复此事实",
  "Remove this fact": "移除此事实",
  "Confirm restoration": "确认恢复",
  "Confirm removal": "确认移除",
  "Preview change": "预览更改",
  "Provider memory history": "记忆服务历史记录",
  "Save memory": "保存记忆",
  "Remove memory": "移除记忆",
  "Undo memory save": "撤销记忆保存",
  "Memory change": "记忆更改",
  Confirmed: "已确认",
  "Outcome unknown": "结果未知",
  "Original change": "原始更改",
  "Requested content": "请求内容",
  "Recorded versions are unavailable.": "记录的版本不可用。",
  "Not stored": "未存储",
  "The provider outcome is unknown. Verify it before another change.":
    "记忆服务的处理结果未知。请先核实，再进行更改。",
  After: "之后",
  Applied: "已应用",
  "Applied version {revision}": "已应用版本 {revision}",
  "Applies when": "适用条件",
  "Apply change": "应用更改",
  "Approve change": "批准更改",
  Approved: "已批准",
  "Available to future runs": "可用于后续运行",
  Before: "之前",
  "Cancel review": "取消审核",
  "Change saved.": "更改已保存。",
  "Change saved. Reload to see the latest version.": "更改已保存。重新加载以查看最新版本。",
  "Changes a business rule.": "此更改会修改业务规则。",
  "Contains guidance for staff only.": "包含仅供员工使用的指导。",
  "Could not complete this review. Reload history and try again.":
    "无法完成此审核。请重新加载历史记录后重试。",
  "Could not complete this review. Reload updates and try again.":
    "无法完成此审核。请重新加载更新后重试。",
  "Could not finish": "未能完成",
  "Could not load history. Try again.": "无法加载历史记录。请重试。",
  Current: "当前",
  "Earlier content is unavailable.": "较早的内容不可用。",
  Empty: "空",
  History: "历史记录",
  "I reviewed the overlapping changes": "我已审核重叠的更改",
  "I reviewed the overlapping edits.": "我已审核重叠的编辑。",
  "Later edits overlap. Review the result before applying.":
    "后续编辑存在重叠。请先审核结果再应用。",
  "Learning queued. Reload updates when it finishes.": "学习任务已排队。完成后请重新加载更新。",
  "Learning restarted": "已重新开始学习",
  "Learning update": "学习更新",
  "Learning updates": "学习更新",
  "Learning…": "正在学习…",
  "Memory and skill history": "记忆和技能历史记录",
  "Memory history": "记忆历史记录",
  "More skills": "更多技能",
  "Needs review": "需要审核",
  "No change needed": "无需更改",
  "No learning updates.": "暂无学习更新。",
  "No recorded changes yet.": "尚无更改记录。",
  "Older changes": "较早的更改",
  "Older updates": "较早的更新",
  "Private across your bots": "仅你拥有的各个机器人可用",
  "Private to this bot": "仅此机器人私用",
  "Reason for decision": "决定理由",
  "Recent decisions": "近期决定",
  Regenerate: "重新生成",
  Reject: "拒绝",
  Rejected: "已拒绝",
  "Reload history": "重新加载历史记录",
  "Reload updates": "重新加载更新",
  "Removed from future runs": "后续运行将不再使用",
  "Replaces the entire current version.": "将替换整个当前版本。",
  ...
  "Review restore": "审核恢复",
  "Review undo": "审核撤销",
  "Shared across this Space": "在此空间共享",
  "Source conversation": "来源对话",
  "Suggestion rejected.": "建议已拒绝。",
  "The destination changed. Regenerate this proposal before approving it.":
    "目标内容已更改。请重新生成此建议后再批准。",
  "The source does not fully support this suggestion. Review the evidence.":
    "来源未完全支持此建议。请审核依据。",
  "This bot": "此机器人",
  Undone: "已撤销",
  "Version {revision}": "版本 {revision}",
  "{name} · Removed": "{name} · 已移除",
  "Download the full source on web.": "请在网页端下载完整来源。",
  "Saved posts: {accepted}": "已保存的帖子：{accepted}",
  "Remove saved posts": "移除已保存的帖子",
  "Deletes this saved copy. Source settings and learned documents stay unchanged.":
    "删除此保存的副本。来源设置和已学习的文档保持不变。",
  "This export is too large. Ask your server administrator for help.":
    "导出内容过大。请向服务器管理员寻求帮助。",
  "Export data": "导出数据",
  "Preparing export…": "正在准备导出…",
  "Couldn't export your data. Try again.": "无法导出数据。请重试。",
  "Sharing is unavailable": "无法共享文件",
  "Staff notification delivery is unconfirmed.": "尚未确认员工通知是否送达。",
  "Could not notify staff.": "无法通知员工。",
  Acknowledge: "确认接手",
  Acknowledged: "已确认接手",
  "Source unavailable or you no longer have access.": "来源不可用或您已无权访问。",
  "Could not remove this source. Reload and try again.": "无法移除此来源。请重新加载后重试。",
  "Hide source": "隐藏来源",
  "View source": "查看来源",
  "{accepted} business replies · {skipped} skipped · {duplicates} duplicates":
    "{accepted} 条商家回复 · 已跳过 {skipped} 条 · {duplicates} 条重复",
  "Evidence through {date}": "截至 {date} 的证据",
  "Source removed. It cannot be used for future learning.": "来源已移除，无法用于后续学习。",
  "Download the full original on web.": "请在网页版下载完整原始文件。",
  "Remove imported source": "移除导入来源",
  "Deletes the original import and stops future learning from it. Existing documents keep their current content.":
    "删除原始导入文件并停止从中学习。现有文档内容保持不变。",
  "Undo change": "撤销更改",
  "Undo version {revision}": "撤销版本 {revision}",
  "Later edits overlap this change. They are kept below. Review before applying.":
    "后续编辑与此更改重叠，已在下方保留。请检查后再应用。",
  "Before this change": "更改前",
  "After this change": "更改后",
  "Current version": "当前版本",
  "Resulting title": "最终标题",
  "Resulting content": "最终内容",
  "Use in customer replies after undo": "撤销后用于客户回复",
  "Reason for undo": "撤销原因",
  "Apply undo": "应用撤销",
  "Staff only": "仅限员工",
  "Adds an audit record and affects future work.": "添加审计记录并影响后续工作。",
  "An earlier action may already have been sent.": "之前的操作可能已经发送。",
  "Applies before the next reply.": "将在下次回复前生效。",
  "Apply guidance": "应用指导",
  "Ask your staff agent to create brand voice or learning documents. File imports are available on web.":
    "请让员工助手创建品牌语气或学习文档。文件导入可在网页版使用。",
  "Audit history": "审计记录",
  "Bot override": "机器人覆盖设置",
  "Could not load learning": "无法加载学习内容",
  "Could not save guidance": "无法保存指导",
  "Could not save. Reload and try again.": "无法保存。请刷新后重试。",
  "Guidance saved": "指导已保存",
  "Guide agent": "指导助手",
  "Learning and brand voice": "学习与品牌语气",
  "Learning content": "学习内容",
  "Private guidance": "内部指导",
  "Reason for change": "修改原因",
  "Restore this version?": "恢复此版本？",
  "Save document": "保存文档",
  "Use in customer replies": "用于客户回复",
  ...
  Staff: "员工",
  Customer: "客户",
  "No customer conversations yet": "暂无客户对话",
  "A deployment administrator must configure this app’s OAuth client.":
    "部署管理员必须配置此应用的 OAuth 客户端。",
  "Account name": "账户名称",
  "Add account": "添加账户",
  "Admin setup required": "需要管理员设置",
  "Admin token": "管理员令牌",
  "Authentication method": "身份验证方式",
  "Authorization failed.": "授权失败。",
  "Authorization is still pending. Check again or cancel.": "授权仍在等待中。请再次检查或取消。",
  "Available actions": "可用操作",
  "Available to everyone in this team.": "此团队的所有成员均可使用。",
  "Back to apps": "返回应用列表",
  "Browse apps": "浏览应用",
  ...
  "Could not refresh accounts. Try again.": "无法刷新账户。请重试。",
  Disconnect: "断开连接",
  "Disconnect account": "断开账户连接",
  "Disconnect this account for everyone in the team?": "要为团队所有成员断开此账户的连接吗？",
  "OAuth setup instructions": "OAuth 设置说明",
  "Open authorization": "打开授权页面",
  Pending: "等待中",
  "Reconnect required": "需要重新连接",
  Retry: "重试",
  "Save OAuth setup": "保存 OAuth 设置",
  "Search OpenConnector apps": "搜索 OpenConnector 应用",
  "Search actions": "搜索操作",
  "Search apps…": "搜索应用…",
  "Set up OpenConnector": "设置 OpenConnector",
  Unavailable: "不可用",
  ...
  "Enter your Deskazo server address.": "输入你的 Deskazo 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  Max: "最高",
  Minimal: "最低",
  ...
  "Point this app at your self-hosted Deskazo origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 Deskazo 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to Deskazo": "登录 Deskazo",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for Deskazo": "注册 Deskazo",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like a Deskazo server": "该地址看起来不是 Deskazo 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. Deskazo adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，Deskazo 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
  ...
  "This subscription sign-in is not available in Deskazo yet. Use a deployment credential or choose another provider.":
    "Deskazo 暂不支持此订阅登录。请使用部署凭据或选择其他提供商。",
  "Tool sources": "工具源",
  Tools: "工具",
  Uninstall: "卸载",
  ...
  High: "高",
  Channel: "渠道",
  "Connect channel": "连接渠道",
  "Could not load conversations": "无法加载会话",
  "Could not save channel settings": "无法保存渠道设置",
  "Could not update conversation": "无法更新会话",
  "Customer channels": "客户渠道",
  "Customer instructions": "客户服务指令",
  Reconnect: "重新连接",
  "Reply failed": "回复失败",
  ...
  Documents: "文档",
  "Add document": "添加文档",
  "Choose a file smaller than 10 MiB.": "请选择小于 10 MiB 的文件。",
  "Connect knowledge": "连接知识库",
  Connection: "连接",
  "Could not load documents. Try again.": "无法加载文档，请重试。",
  "Could not save the document change. Try again.": "无法保存文档更改，请重试。",
  "Knowledge service URL": "知识服务 URL",
  "No documents yet.": "暂无文档。",
  Processing: "处理中",
  "Processing failed. Replace the file to retry.": "处理失败，请替换文件后重试。",
  Ready: "就绪",
  Replace: "替换",
  "Update failed. Previous version is available.": "更新失败，仍可使用上一版本。",
  Updating: "更新中",
  "Use shared knowledge": "使用共享知识库",
  "Delete document?": "删除文档？",
  "File sharing is unavailable on this device.": "此设备不支持文件共享。",
  Download: "下载",
};
